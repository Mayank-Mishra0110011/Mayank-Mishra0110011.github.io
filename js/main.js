...
const projectInfo = {
  ...
  astar: {
    ...
    github:
      "https://github.com/Mayank-Mishra0110011/A-Star-Path-Finding-Algorithm-Visualiser",
  ...
  dataStruct: {
    ...
    github:
      "https://github.com/Mayank-Mishra0110011/Data-Structure-and-Algorithms-Visualized",
    stack: "JavaScript, P5.js, P5.dom.js",
  },
  dijkstra: {
    ...
    description:
      "Visualization sketch of dijkstra's shortest path finding algorithm",
    github:
      "https://github.com/Mayank-Mishra0110011/Dijkstra-s-Algorithm-Visualization",
    stack: "JavaScript, P5.js, P5.dom.js",
  },
  eca: {
    ...
    github:
      "https://github.com/Mayank-Mishra0110011/Elementary-Cellular-Automaton",
    stack: "JavaScript, P5.js",
  },
  japanese: {
    ...
    description:
      "A quiz game to test your hiragana, katakana and vocabulary skills. Need more content!",
    github:
      "https://github.com/Mayank-Mishra0110011/Japanese-Language-Quiz-Game",
    stack: "JavaScript, P5.js",
  },
  math: {
  ...
  pps: {
    ...
    github:
      "https://github.com/Mayank-Mishra0110011/Primordial-Particle-System",
  ...
  weather: {
    ...
    img: "../img/weather.png",
    description:
      "Visualization of Global Wind Data. The API has been deprecated!",
  ...
  chatio: {
    title: "Chat.io",
    img: "../img/chatio.png",
    description: `Chat.io is an all in one text, video and audio chat application. It allows user to create/join a server with channel based text/audio/video interface. Users can also send private messages to other users with private voice and video calling feature. It also provides server creator and admins to restrict access to certain channels and it's features. Server creator and admins can also create and assign "roles" to server members which provides exclusive privileges to the user.`,
    github: "https://github.com/Mayank-Mishra0110011/Chat.io",
    stack:
      "JavaScript, CSS, HTML, Node.js, Express.js, React.js, MongoDB, Socket.io",
  },
  memochou: {
    title: "Memochou",
    img: "../img/memochou.png",
    description: `Memochou is note taking application that helps you add notes, lists, reminders and images enabling organization and productivity`,
    github: "https://github.com/Mayank-Mishra0110011/Memochou",
    stack: "JavaScript, CSS, HTML, Node.js, Express.js, React.js, MongoDB",
  },
  stonks: {
    title: "Stonks",
    img: "../img/stonks.png",
    description: `Stonks is a stock/indicator visualization desktop application.`,
    github: "https://github.com/Mayank-Mishra0110011/stonks",
    stack: "Electron, JavaScript, CSS, HTML, Node.js, Express.js",
  },
};
...
window.onload = function () {
  ...
  if (window.innerWidth > 500) {
    TweenMax.fromTo(
      ...
      },
      {
        ...
        onComplete: () => {
          this.document.getElementsByClassName("line1")[0].style.borderRight =
            "none";
          this.document.getElementsByClassName("line2")[0].style.visibility =
            "visible";
          TweenMax.fromTo(
            ".anim2",
            5,
            ...
            },
            {
              ...
              onComplete: () => {
                this.document.getElementsByClassName(
                  "line2"
                )[0].style.borderRight = "none";
                this.document.getElementsByClassName(
                  "line1"
                )[0].style.whiteSpace = "normal";
                this.document.getElementsByClassName(
                  "line2"
                )[0].style.whiteSpace = "normal";
              },
  ...
  window.addEventListener("scroll", () => {
    if (
      document.body.scrollTop > 58 ||
      document.documentElement.scrollTop > 58
    ) {
      if (!$("nav").hasClass("sticky-top")) {
        $("nav").addClass("sticky-top");
        TweenMax.set("nav", { autoAlpha: 0 });
    ...
    if (window.scrollY > 980) {
      for (let k in knowledge) {
        ...
        this.document.getElementById(k).style.width = `${
          80 * ((100 - knowledge[k]) / 100)
        }%`;
...
function sendEmail(e) {
  ...
  if (
    ...
    const url =
      "https://script.google.com/macros/s/AKfycbzRs1_iAU353yCOjC1z5hLbtdYuf9bRNxEA3tzH7SFZSu0NO6E/exec";
    const data = {
      Name: name.value,
      Email: email.value,
